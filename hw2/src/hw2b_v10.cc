// MPI static load (interleaving), vectorization optimized
// No collapse: view each "row" as a chunk (dynamic chunk size, eqivalent to width)
// omp schedule(dynamic, 1) -> (20241101) 84.50 s
// Collapse: static chunk size
// omp collapse(2) schedule(dynamic, 1) -> (20241101) 85.45 s
// omp collapse(2) schedule(dynamic, 20) -> (20241101) 85.19 s
// omp collapse(2) schedule(dynamic, 64) -> (20241101) 84.94 s
// omp collapse(2) schedule(dynamic, 100) -> (20241101) 85.36 s
// omp collapse(2) schedule(dynamic, 200) -> (20241101) 85.40 s
