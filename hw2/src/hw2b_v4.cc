// For profiling
// dynamic load balancing, vectorization, omp
// mpi chunk size 20(1,)        -> (dynamic) 104.51 s
// mpi chunk size 40(1,)        -> (dynamic) 98.24 s
// mpi chunk size 60(1, 2, 4)   -> (dynamic) 96.04, 98.28, 108.85 s
// mpi chunk size 80(1,)        -> (dynamic) 98.08 s
// mpi chunk size 100(1,)       -> (dynamic) 96.83 s
// mpi chunk size 120(1, 2, 4)  -> (dynamic) 96.67, 97.89, 100.20 s
//                              -> (static)  97.39, 98.96, 102.85 s
// mpi chunk size 200(1,)       -> (dynamic) 99.44 s
// Load imbalance becomes more significant than scheduling overhead, when the work size is small (120), meaning the smaller the chunk size, the more balanced.
