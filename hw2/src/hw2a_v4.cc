// For profiling
// Static load with continuous data
// Copy directly onto image (with 256 bit, 8 elements at a time, correctly done) -> 151.53 s
// Calculate vec_x2, vec_y2 first -> 150.73 s
...
private:
    ...
    void compute(int thread_id) // void (MandelbrotGenerator::*)(int)
    {
